...
let PostImages = class PostImages extends typeorm_1.BaseEntity {
};
__decorate([
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => MissingPost_1.MissingPost, (post) => post.images, { onDelete: 'CASCADE' }),
    __metadata("design:type", MissingPost_1.MissingPost)
], PostImages.prototype, "post", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => type_graphql_1.Int),
    (0, typeorm_1.PrimaryColumn)(),
    __metadata("design:type", Number)
], PostImages.prototype, "photoId", void 0);
__decorate([
...
], PostImages.prototype, "photo", void 0);
