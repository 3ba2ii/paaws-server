...
export class NewGenMigration1641397980660 implements MigrationInterface {
  name = 'NewGenMigration1641397980660';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "photo" ("id" SERIAL NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "filename" character varying NOT NULL, "url" character varying NOT NULL, "creatorId" integer NOT NULL, CONSTRAINT "PK_723fa50bf70dcfd06fb5a44d4ff" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "missing_post" ("id" SERIAL NOT NULL, "addressId" integer, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, "title" text NOT NULL, "description" text NOT NULL, "privacy" "missing_post_privacy_enum" DEFAULT 'public', "type" "missing_post_type_enum" DEFAULT 'missing', "points" integer NOT NULL DEFAULT '0', "commentsCount" integer NOT NULL DEFAULT '0', "thumbnailId" integer, "showContactInfo" boolean NOT NULL DEFAULT true, CONSTRAINT "REL_583c9b02331fdb7c28a1bdcc25" UNIQUE ("addressId"), CONSTRAINT "REL_0e84abeabb4844d84e2d563a2f" UNIQUE ("thumbnailId"), CONSTRAINT "PK_218ad2ead5f6086cbd2dd4abb02" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
